...
const Data = [
...

   {
    ...
    grade: 'CUTURAL RELAX',
    fees: '$790',
    description: `Angkot wat represents the entire range of khamer art from the 9th
...

   {
    ...
    emperor Shah Jahan in memory of his wife Mumtaz, the monument is breathtakingly
    beautiful. This place is known for its luxurious stays and 
    adventurous activities`
   },
...

   {
    ...
    mountains, history, art & culture, food, temples and beautiful sandy beaches.`
   },
    ...
    <section className='main container section'>
      ...
      <div className="secContent grid">
        {/* So guys, here we are going to use high ordfer array method(map).
          ...
          fetch each destinaton at once. I hope this will make sence to you! */}
